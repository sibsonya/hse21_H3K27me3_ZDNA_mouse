...
### Ассоциирование пересечений H3K27me3 и ZDNA_mouse_1 с ближайшими генами

Количество пиков, которые удалось проассоциировать с генами: 18  
Общее количество уникальных генов: 17

### GO-анализ уникальных генов

К сожалению, GO-анализ не дал ни одного статзначимого результата. Увеличение "зоны поиска" генов на пересечениях также не привело ни к каким результатам. Полученный файл со всеми результатами GO_analysis.txt представлен в папке data.
